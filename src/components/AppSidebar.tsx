  ...
  const menuGroups = [
    {
      ...
      items: [
        ...
        { title: "Fluxo de Fechamento", url: "/fechamento-mensal", icon: Lock },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Aging (0-30-60-90)", url: "/aging-report", icon: Clock },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Importar Holerite", url: "/importar-holerite", icon: Upload },
