-- ============================================================================
-- MOVER LANÇAMENTOS PARA CONTAS ESPECÍFICAS
-- ============================================================================
-- Cada despesa na conta certa - não usar "Outras Despesas" (4.1.2.99)
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '=== MOVENDO PARA CONTAS ESPECÍFICAS ===';

  -- OUTSIDER CONSTRUTORA -> 4.1.2.11 Obras e Reformas Sede
  ...
  -- DEP. PESSOAL, CONTÁBIL, FISCAL, FINANCEIRO -> 4.1.2.13 Serviços Terceirizados
...
DECLARE
  v_rec RECORD;
BEGIN
  RAISE NOTICE '=== DRE APÓS REORGANIZAÇÃO ===';
