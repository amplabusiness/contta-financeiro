 ...
 */
async function processAllPending(supabase: any, aiKey: string | undefined, provider: string, log: LogFn) {
 ...
 */
async function processInvoices(supabase: any, log: LogFn) {
 ...
 * PROCESSAR DESPESAS
 */
async function processExpenses(supabase: any, log: LogFn) {
 ...
 * PROCESSAR CONTRATOS
 */
async function processContracts(supabase: any, log: LogFn) {
 ...
 */
async function processPayments(supabase: any, log: LogFn) {
 ...
 */
async function provisionMonthlyFees(supabase: any, competence: string | undefined, log: LogFn) {
 ...
 * GERAR BALANCETE
 */
async function generateTrialBalance(supabase: any, periodType: string, competence: string, log: LogFn) {
 ...
 */
async function closeFiscalYear(supabase: any, fiscalYear: number, aiKey: string | undefined, provider: string, log: LogFn) {
 ...
 */
async function generateBalanceSheet(supabase: any, fiscalYear: number, log: LogFn) {
