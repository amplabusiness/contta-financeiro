 ...
 */
async function processAllPending(supabase: any, aiKey: string | undefined, provider: string, log: (...args: unknown[]) => void) {
 ...
 */
async function processInvoices(supabase: any, log: (...args: unknown[]) => void) {
 ...
 * PROCESSAR DESPESAS
 */
async function processExpenses(supabase: any, log: (...args: unknown[]) => void) {
 ...
 * PROCESSAR CONTRATOS
 */
async function processContracts(supabase: any, log: (...args: unknown[]) => void) {
 ...
 */
async function processPayments(supabase: any, log: (...args: unknown[]) => void) {
 ...
 */
async function provisionMonthlyFees(supabase: any, competence: string | undefined, log: (...args: unknown[]) => void) {
 ...
 * GERAR BALANCETE
 */
async function generateTrialBalance(supabase: any, periodType: string, competence: string, log: (...args: unknown[]) => void) {
 ...
 */
async function closeFiscalYear(supabase: any, fiscalYear: number, aiKey: string | undefined, provider: string, log: (...args: unknown[]) => void) {
 ...
 */
async function generateBalanceSheet(supabase: any, fiscalYear: number, log: (...args: unknown[]) => void) {
