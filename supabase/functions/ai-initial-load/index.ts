 ...
 */
async function fullInitialLoad(supabase: any, aiKey: string | undefined, provider: string, log: (msg: string) => void) {
 ...
 */
async function setupChartOfAccounts(supabase: any, log: (msg: string) => void) {
 ...
 */
async function processOpeningBalances(supabase: any, log: (msg: string) => void) {
 ...
 */
async function processJanuaryInvoices(supabase: any, log: (msg: string) => void) {
 ...
 */
async function processBankStatement(supabase: any, aiKey: string | undefined, provider: string, log: (msg: string) => void) {
 ...
 */
async function generateOpeningReports(supabase: any, log: (msg: string) => void) {
 ...
 */
async function validateBankBalance(supabase: any, log: (msg: string) => void) {
