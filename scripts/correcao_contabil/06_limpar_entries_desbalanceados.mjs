// scripts/correcao_contabil/06_limpar_entries_desbalanceados.mjs
...
async function limparDesbalanceados() {
  ...
  if (MODO === 'SIMULACAO') {
    ...
    console.log('   node scripts/correcao_contabil/06_limpar_entries_desbalanceados.mjs --executar');
