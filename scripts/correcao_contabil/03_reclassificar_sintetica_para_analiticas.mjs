// scripts/correcao_contabil/03_reclassificar_sintetica_para_analiticas.mjs
...
async function reclassificarSintetica() {
  ...
  if (MODO === 'SIMULACAO') {
    ...
    console.log('   node scripts/correcao_contabil/03_reclassificar_sintetica_para_analiticas.mjs --executar');
